...
void insert(List* l, char it){
    ...
    printf("%d %c", l->cnt, l->curr->next->element);
}
...
char removed(List* l){
    ...
    printf("elementos: %c%c", it, l->curr->next->element);
...
int find(List* l, char it){
    ...
    printf("elementos: %c %c", l->curr->next->element, temp->next->element);
